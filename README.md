...
# Additinoal references

1. The theme is derived from a Bootstrap template, featuring pure HTML, CSS, and Bootstrap elements. You can find the template for reference at this link :- https://bootstrapbrain.com/demo/?s=templates/wave/wave-lite

2. Our project utilizes a webpack-based setup, streamlining HTML, CSS, and package management for enhanced usability. For further details, refer to the repository at:- https://github.com/WeAreAthlon/frontend-webpack-boilerplate?tab=readme-ov-file#demo

3. Additionally, we explored an alternative webpack boilerplate project, which incorporates pre-installed Bootstrap elements and adept file management. Further insights can be found at:- https://github.com/noreading/bootstrap5-webpack-boilerplate

4. In our project, we incorporate images generated by Microsoft Edge's AI CoPilot, ensuring high-quality visuals.

# Image Size Information

1. Home Page Picture: The image should have dimensions of 1100 pixels width and 1100 pixels height.

2. About Page Picture: The image should have dimensions of 491 pixels width and 511 pixels height.

3. Blog Page Picture: The image should have dimensions of 1200 pixels width and 800 pixels height.

4. Contact Page Picture: The image should have dimensions of 800 pixels width and 900 pixels height.
